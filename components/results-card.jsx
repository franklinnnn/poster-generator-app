...
export const ResultsCard = ({ item, layout }) => {
  ...
  return (
    <div onClick={handleSelectResult} className="hover:cursor-pointer">
      {layout ? (
        <div className="relative rounded-none h-24 overflow-hidden group">
          <div className="flex gap-4 absolute top-0 left-0 w-full font-bold z-10">
            ...
            <div className="p-2 group-hover:pr-6 transition-all">
              <p className="text-3xl font-display">{item.name}</p>
          ...
          <img
            ...
            alt="Album cover"
            className="w-3/4 blur-3xl group-hover:w-full transition-all"
          />
        </div>
      ) : (
        <div className="relative rounded-md aspect-square h-60 overflow-hidden group">
          <div className="absolute bottom-0 left-0 p-2 w-full bg-gradient-to-b from-secondary to-base-200 to-90% hidden font-bold group-hover:block z-10 transition">
